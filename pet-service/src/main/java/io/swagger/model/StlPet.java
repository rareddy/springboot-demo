...
@Entity
@TextTable(file="/home/rareddy/testing/PetStore/stlpets.csv")
public class StlPet {
	@JsonProperty("id")
	@Id
	...
	public StlPet name(String name) {
		this.name = name;
		return this;
	}
	...
	public StlPet type(String type) {
		this.type = type;
		return this;
	}
	...
	public StlPet status(StatusEnum status) {
		this.status = status;
		return this;
	}
